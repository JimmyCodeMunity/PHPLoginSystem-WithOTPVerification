...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $insert = "INSERT INTO user(uid,username,email,password,otp,expirationtime)VALUES('$uid','$username','$email','$password','$otp','$formattedExpirationTime')";
...
<body class="bg-black">
    <div class="container-fluid">
      ...
      <div class="inputForm">
        ...
        <input type="text" name="username" class="input" placeholder="Enter your Email">
      </div>
    <div class="flex-column">
